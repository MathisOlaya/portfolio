...
function TaskBar() {
  ...
  return (
    <div className="absolute flex bottom-0 w-full bg-gray-950 border-t border-gray-700 justify-between items-center">
      <div className="flex">
        <FaWindows size={24} className="mr-4 m-3" />
        <div className="gap-1 flex">
          {openApps.map((app) => {
            return (
              <div onClick={() => toggleAppMinimize(app)} key={app.id} className="flex align-contents-center gap-2 hover:bg-gray-900 p-3">
